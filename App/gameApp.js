...
.directive("centipedeGame", ["$interval", "gameService", "renderService", "graphicsEngineService", function ($interval, gameService, renderService, graphicsEngineService) {
    return {
        restrict: 'A',
        template: '<canvas id="gameCanvas" width="600"; background-image: url("img/bg.png"); height="640" style="text-align: center; position: absolute; border:1px solid blue; left:50%; top: 50%; transform: translate(-50%,-50%);"></canvas>',
